...
2. 質問への回答試行を Burp Intruder で繰り返し、レート制限・ロックがあるか確認
   > ⚠️ **負荷注意（手順2）**: 秘密の質問の総当りはアカウントロックやリセットフロー濫用を招く。テストアカウントで少数から。
...
- **手順2**: 秘密の質問の総当りはアカウントロックやリセットフロー濫用を招く。テストアカウントで少数から。
